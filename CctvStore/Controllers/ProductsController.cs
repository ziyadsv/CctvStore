...
namespace CctvStore.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductId,ProductName,Description,SubCategoryId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductId,ProductName,Description,SubCategoryId")] Product product)
        {
            if (ModelState.IsValid)
            {
